...
<?php
    ...
    if ($result->num_rows > 0) {
        while ($row = $result->fetch_assoc()) {
            ...
            echo "<div class='col'>
            <a class='text-decoration-none text-black' href='spec.php?film=$titolo'>
                <div class='card' style='width: 18rem;'>
                    <img src='$url' class='card-img-top' alt='...'>
                    <div class='card-body'>
                        <h5 class='card-title'>$titolo</h5>
                        <p class='card-text mt-3'>$trama</p>
                        <a href='riepilogoNoleggio.php?film=$titolo' class='btn btn-primary mt-3'>Noleggia
